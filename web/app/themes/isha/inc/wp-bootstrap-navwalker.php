...
class isha_navwalker extends Walker_Nav_Menu {
        ...
        if ( $container ) {
          ...
          if ( $menu_id ) {
            ...
            if ( $menu_class ) {
              ...
              echo '>';
              echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="">' . esc_attr__( 'Add a menu', 'isha' ) . '</a></li>';
              echo '</ul>';
              if ( $container ) {
                echo '</' . esc_attr( $container ) . '>'; }
              }
