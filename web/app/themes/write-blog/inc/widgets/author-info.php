<?php
/**
 * Adds Write_Blog_Author_Info widget.
 */
class Write_Blog_Author_Info extends WP_Widget {
    /**
    ...
    function __construct() {
        parent::__construct(
            'write_blog_author_info_widget',
            esc_html__( 'WB: Author Info', 'write-blog' ),
            array( 'description' => esc_html__( 'Displays author short info.', 'write-blog' ), )
        );
    }
        ...
        <div class="author-info">
            ...
            <div class="author-social">
                ...
                <?php if (!empty($instance['instagram_url'])) { ?>
                    <a href="<?php echo esc_url($instance['instagram_url']); ?>" target="_blank"><i class="meta-icon ion-social-instagram"></i></a>
                <?php } ?>
            </div>
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>">
                <?php esc_attr_e('Title:', 'write-blog'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('author_name')); ?>">
                <?php esc_attr_e('Author Name:', 'write-blog'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('author_desc')); ?>">
                <?php esc_attr_e('Short Description:', 'write-blog'); ?>
            </label>
        ...
        <div>
            <label for="<?php echo esc_attr( $this->get_field_id( 'author_img' ) ); ?>">
                <?php esc_attr_e('Author Image:', 'write-blog'); ?>
            </label>
            <!-- <br /> -->
            <input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'write-blog' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'write-blog' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'write-blog' ); ?>" />
            <?php
            $image_status = false;
            if ( ! empty( $author_img ) ) {
                $image_status = true;
            ...
            ?>
            <input type="button" value="<?php echo _x( 'X', 'Remove', 'write-blog' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('fb_url')); ?>">
                <?php esc_attr_e('Facebook URL:', 'write-blog'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('twitter_url')); ?>">
                <?php esc_attr_e('Twitter URL:', 'write-blog'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('instagram_url')); ?>">
                <?php esc_attr_e('Instagram URL:', 'write-blog'); ?>
            </label>
