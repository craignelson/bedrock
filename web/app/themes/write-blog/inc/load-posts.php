...
if ( ! function_exists( 'write_blog_ajax_pagination' ) ) :
    /**
...
if ( ! function_exists( 'write_blog_load_more' ) ) :
    /**
...
add_action( 'wp_ajax_write_blog_load_more', 'write_blog_load_more' );
add_action( 'wp_ajax_nopriv_write_blog_load_more', 'write_blog_load_more' );